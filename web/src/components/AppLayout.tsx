...
export default function AppLayout({
    ...
    return (
        <ProtectedRoute allowedRoles={allowedRoles}>
            <div className="relative flex h-screen w-full overflow-hidden text-text-body">
                <div className="pointer-events-none absolute inset-0 bg-grid-pattern opacity-[0.14]" />
                <div className="hero-orb -top-24 left-[12%] h-72 w-72 bg-primary/30" />
                ...
                <main className="relative flex min-w-0 flex-1 flex-col overflow-hidden">
                    <header className="glass-heavy sticky top-0 z-20 border-b border-white/10">
                        <div className="mx-auto flex w-full max-w-[1480px] items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
                            <div className="min-w-0">
                                ...
                                <h2 className="truncate text-2xl font-extrabold text-white sm:text-[1.75rem]">{title}</h2>
